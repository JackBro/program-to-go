...
language_c::language_c(setupfile_c * aSetup, SystemDefault_c * SystemDefault) : collection_c() {
  current = -1;
...
//////////////////////////////
  setup = aSetup;
  int ConfigLang = hexToInt(setup->getLang());
...
int language_c::setSetup(setupfile_c * aSetup) {
  setup = aSetup;
  return 0;
}
